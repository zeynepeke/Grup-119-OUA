...
public class Silahlanma : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (isStrafe == true)
        {
            GetComponent<CharController>().hareketTipi = CharController.MovementType.Strafe;
        ...
        if (isStrafe == false)
        {
            GetComponent<CharController>().hareketTipi = CharController.MovementType.Directional;
